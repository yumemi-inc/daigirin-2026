...
> **💡ポイント:** 「ウォレットのアドレス」と「自分のお釣り用のアドレス」が異なるように記載されていますが問題ありません。後者は、HD（Hierarchical Deterministic）ウォレットと呼ばれ、1つのシードフレーズから複数アドレスを階層的に導出する仕組みで、すべてのアドレスの秘密鍵はシードから再計算可能です。つまりアドレスが異なっても、同一シードの管理下にあるため資金の所有権を失うことはありません。
...
- Token Extensions (Token-2022) <span class="footnote">https://spl.solana.com/token-2022</span>
- Compressed NFTs (Metaplex Bubblegum) <span class="footnote">https://developers.metaplex.com/bubblegum</span>
